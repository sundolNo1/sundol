  ...
  return (
    <main className="min-h-screen bg-[#06090f] px-3 py-3 sm:p-4 md:p-8 relative overflow-x-hidden">
      ...
      <div className="relative max-w-6xl mx-auto space-y-3 sm:space-y-6">
        {/* 헤더 */}
        <div className="fade-up text-center pt-4 sm:pt-8 pb-1 sm:pb-2" style={{ animationDelay: "0ms" }}>
        ...
        <div className="fade-up" style={{ animationDelay: "160ms" }}>
          <Link
            href="/games"
            className="bg-white/[0.03] backdrop-blur-xl rounded-2xl px-4 py-3.5 sm:p-5 border border-white/[0.07] hover:border-amber-400/25 hover:bg-white/[0.05] hover:shadow-[0_0_32px_rgba(251,191,36,0.07)] hover:-translate-y-0.5 transition-all duration-300 group flex items-center gap-3 sm:gap-5"
          >
        ...
        <div className="fade-up grid grid-cols-2 gap-3 sm:gap-4" style={{ animationDelay: "240ms" }}>
        ...
        <div className="fade-up grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4" style={{ animationDelay: "320ms" }}>
          <div className="hover:shadow-[0_0_32px_rgba(251,191,36,0.07)] hover:-translate-y-0.5 transition-all duration-300 rounded-2xl">
            <BookmarksWidget />
          </div>
          <div className="hover:shadow-[0_0_32px_rgba(251,191,36,0.07)] hover:-translate-y-0.5 transition-all duration-300 rounded-2xl">
