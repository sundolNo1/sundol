          ...
          >
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm font-semibold text-white/70">위젯 설정</span>
                <button
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border transition-all text-left ${
                      vis[key]
                        ...
                        : "bg-white/[0.03] border-white/[0.06] text-white/25 line-through"
                    }`}
                  >
                    <span className="text-base">{icon}</span>
                    <span className="text-xs font-medium">{label}</span>
                    <div className={`ml-auto w-2 h-2 rounded-full flex-shrink-0 ${vis[key] ? "bg-amber-400/70" : "bg-white/10"}`} />
                  </button>
                ))}
              </div>

              <p className="text-white/15 text-[10px] mt-3 text-center tracking-wide">
                클릭으로 위젯 표시 / 숨기기
              </p>
            </div>
          </div>
